...
package body Controller_Help is
   ...
   begin
      Call_OS_CLI("Filer_Run <TBKeyList$Dir>.!Help");
   exception
   ...
   begin
      if StrongHelp.Run then
         case Menu_Entry is
         when 16#0#	=> Call_OS_CLI("stronghelp <TBKeyListRes$Dir>.TBKeyList Intro");
         when 16#1#	=> Call_OS_CLI("stronghelp <TBKeyListRes$Dir>.TBKeyList Install");
         when 16#2#	=> Call_OS_CLI("stronghelp <TBKeyListRes$Dir>.TBKeyList Start");
         when 16#3#	=> Call_OS_CLI("stronghelp <TBKeyListRes$Dir>.TBKeyList Problems");
         when 16#4#	=> Call_OS_CLI("stronghelp <TBKeyListRes$Dir>.TBKeyList Bugz");
         when 16#5#	=> Call_OS_CLI("stronghelp <TBKeyListRes$Dir>.TBKeyList Language");
         when 16#6#	=> Call_OS_CLI("stronghelp <TBKeyListRes$Dir>.TBKeyList History");
         when 16#7#	=> Call_OS_CLI("stronghelp <TBKeyListRes$Dir>.TBKeyList Third");
         when 16#8#	=> Call_OS_CLI("stronghelp <TBKeyListRes$Dir>.TBKeyList Licence");
         when others=> null;
         end case;
      end if;
   exception
